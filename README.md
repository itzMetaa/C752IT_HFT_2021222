...
NEW:
InMemory databasenél nem működik a cascade delete, sqlserver-el működik. A connection region-ben kell átkommentelni hogy átváltson a másik server típusra.
Nincs lekezelve a bekérés, funkcionalitás szempontjából feltételezzük, hogy tökéletes felhasználó használja a programot.

Startup projectek: WpfClient és Endpoint
